...
const PopularCategoryCard = ({title}) => {
  return (
    <div
                className="swiper-slide w-[273px] mr-[16px] flex  items-center shrink-0 swiper-slide-next"
              >
                <a
                ...
                >
                  ...
                  />
                  <span className="mt-4 transition-colors duration-150 sm:group-hover:text-[#707070]">
                    {title}
                  </span>
                </a>
              </div>
